	...
	.defines(function () {
		...
		var MyGame = ig.GameExtended.extend({
			...
			initUI: function () {
				...
				// button for sharing the room
				// istanziare per primo il pulsante per la condivisione della stanza di gioco


				//button per mettere in pausa il gioco
			...
			checkItemTimer: function () {
				// prendere tutti gli elementi itemRed, itemBlue e itemYellow
				// controllare se sono stati eliminati
				// ricreare gli elementi eliminati
